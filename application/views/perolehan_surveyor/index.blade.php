        ...
        <div class="col-md-9">
            ...
            <div class="card card-custom card-sticky" data-aos="fade-down" data-aos-delay="300">
                <div class="card-body">
                    ...
                    <br>
                    <table class="table table-bordered table-hover" cellspacing="0" width="100%" border="1">
                        <tr class="bg-secondary" style="font-weight: bold;">
                            <td>Total Perolehan :</td>
                            <td><span class="badge badge-info badge-lg font-weight-bold"><?php echo $total_perolehan ?>
                                    Responden</span>
                            </td>
                        </tr>
                    </table>
