            ...
            <div class="card card-custom bgi-no-repeat gutter-b"
                ...
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        @php
                        echo anchor(base_url(). $ci->session->userdata('username') . '/' . $ci->uri->segment(2) .
                        '/rekap-alasan/cetak',
...
$(document).ready(function() {
    table = $('#table').DataTable({
        ...
        "pageLength": 5,
        "ajax": {
            "url": "<?php echo base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/rekap-alasan/ajax-list' ?>",
            "type": "POST",
            "data": function(data) {}
        },
