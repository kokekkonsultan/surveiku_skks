	...
	<div class="container-fluid d-flex align-items-stretch justify-content-between">
		<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
			<div class="header-logo">
				...
				<a href="{{ base_url() }}{{ $ci->session->userdata('username'); }}">
				...
				<ul class="menu-nav">
					...
					{{-- <li class="menu-item menu-item-submenu menu-item-rel menu-item-active" data-menu-toggle="click" aria-haspopup="true">
						<a href="javascript:;" class="menu-link menu-toggle">
							<span class="menu-text">Sampling</span>
						...
						<div class="menu-submenu menu-submenu-classic menu-submenu-left">
							...
							<ul class="menu-subnav">
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ base_url() }}sampling/krejcie" class="menu-link">
										...
										<span class="menu-text">Krejcie</span>
									</a>
								</li>

								<li class="menu-item" aria-haspopup="true">
									<a href="{{ base_url() }}sampling/cochran" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Clothes/Briefcase.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Cochran</span>
									</a>
								</li>

								<li class="menu-item" aria-haspopup="true">
									<a href="{{ base_url() }}sampling/slovin" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Clothes/Briefcase.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Slovin</span>
									</a>
								</li>
