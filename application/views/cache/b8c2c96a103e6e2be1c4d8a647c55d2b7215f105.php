    ...
    <div class="card card-custom card-stretch-half gutter-b overflow-hidden mb-5">
        <div class="card-body d-flex p-0">
            <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start"
                style="background-color: #082d52; background-position: right bottom; background-size: 100% auto; background-image: url(/assets/img/banner/rhone-2.svg)">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_skks\application\views/dashboard/index.blade.php ENDPATH**/ ?>