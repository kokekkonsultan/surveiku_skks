        ...
        <div class="col-md-9">
            ...
            <div class="card card-custom card-sticky" data-aos="fade-down">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ base_url() }}{{ $ci->session->userdata('username') }}/{{ $ci->uri->segment(2) }}/scan-barcode/do?bg=light"
                        ...
                        <div class="col-md-6">
                            <a href="{{ base_url() }}{{ $ci->session->userdata('username') }}/{{ $ci->uri->segment(2) }}/scan-barcode/do?bg=dark"
            ...
            <div class="card mt-5" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <form
                        action="{{ base_url() }}{{ $ci->session->userdata('username') }}/{{ $ci->uri->segment(2) }}/scan-barcode/get"
                        method="POST">
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="link" class="form-control" id="lbl_1" aria-describedby="help_1"
                                value="{{ base_url() }}survei/{{ $ci->uri->segment(2) }}">
                        </div>
            ...
            <div class="card mt-5 mb-5" data-aos="fade-down">
                <div class="card-body text-center">
                    ...
                    <br><br>
                    {!!
                    anchor(base_url().$ci->session->userdata('username').'/'.$ci->uri->segment(2).'/scan-barcode/download',
                    'Download QR Code', ['class' => 'btn btn-primary']) !!} {!!
                    anchor(base_url().$ci->session->userdata('username').'/'.$ci->uri->segment(2).'/scan-barcode/clear-data',
