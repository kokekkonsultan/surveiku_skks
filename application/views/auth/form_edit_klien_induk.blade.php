                        ...
                        <div class="col-sm-9">
                            <div class="checkbox-list">
                                ...
                                <label class="checkbox">
                                    <input type="checkbox" name="cakupan[]" value="{{$row->id_survey}}" <?php echo in_array($row->id_survey, $survei_checked) ? 'checked' : '' ?>>
                                    <span></span> {{$row->survey_name}} ({{$row->first_name . ' ' . $row->last_name}})
                                </label>
                                @endforeach
