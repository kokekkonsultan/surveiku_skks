            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="radio-list mb-5">
                                @foreach($kelompok_skala->result() as $row)
                                <label class="radio"><input type="radio" name="id_kelompok_skala" value="{{$row->id}}"
                                        class="tamplate"><span></span>&nbsp {{$row->nama_kelompok_skala}}</label>
                                @endforeach
                            </div>
                        </div>
                    </div>
