...
<div class="d-lg-flex half">
	...
	<div class="bg order-1 order-md-2" style="background-image: url('{{ base_url() }}assets/img/site/auth/bg_4.jpg');">
					...
					{!! form_open("auth/login") !!}
						...
						<div class="row mb-5">
							...
							<!-- <div class="col-md-6 text-end">
								<span class="ml-auto"><a href="{{ base_url() }}auth/forgot_password" class="forgot-pass text-white" style="text-decoration: none;">Lupa Password</a></span>
							</div> -->
						</div>
