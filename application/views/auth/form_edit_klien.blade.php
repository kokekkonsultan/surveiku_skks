        ...
        {!! form_open(uri_string()); !!}
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="radio-list mb-5">
                                <label class="radio"><input type="radio" name="cek_res" id="2" value="2"
                                        class="tamplate" <?php if($user->is_reseller == '') { echo 'checked';} ?>><span></span>&nbsp Tidak</label>
                                <label class="radio"><input type="radio" name="cek_res" id="1" value="1"
                                        class="tamplate" <?php if($user->is_reseller != '') { echo 'checked';} ?>><span></span>&nbsp Ya</label>
                            </div>
                            ...
                            WHERE group_id = 4');
                            @endphp
                            <select class="form-control" name="is_reseller" id="is_reseller" <?php if($user->is_reseller == '') { echo 'style="display: none;"'; } else { 'required'; } ?>>
            ...
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Klasifikasi Survei <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
            ...
            <div class="text-right mt-5 mb-5">
                {!! anchor(base_url().'pengguna-klien', 'Cancel', ['class' => 'btn btn-light-primary font-weight-bold shadow-lg']) !!}
                {!! form_submit('submit', lang('edit_user_submit_btn'), ['class' => 'btn btn-primary font-weight-bold shadow-lg']); !!}
            </div>

        
            <div class="mt-5">
                  <a class="btn btn-danger font-weight-bold" href="javascript:void(0)" title="Hapus" onclick="delete_data({{ $ci->uri->segment(3) }})">Hapus Pengguna Ini</a>
            </div>
        {!! form_close(); !!}
