                    ...
                    <div class="account-settings">
                        <div class="user-profile">
                            <div class="user-avatar">
                                ...
                                <img src="{{ base_url() }}assets/klien/foto_profile/200px.jpg" alt="Maxwell Admin"
                                    style="width: 150px; height:150px;">
                                <?php else : ?>
                                <img src="{{ base_url() }}assets/klien/foto_profile/{{ $data_user->foto_profile }}"
                ...
                <div class="card-body">
                    <form method="post" action="<?= $form_action ?>" enctype="multipart/form-data">
                        <div class="row gutters">
                            ...
                            @if($kelompok_skala->num_rows() != 0)
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="font-weight-bold">Kelompok Skala</label>
                                    <input type="text" class="form-control" value="{{ $kelompok_skala->row()->nama_kelompok_skala }}" disabled>
                                </div>
                            </div>
                            @endif
                        </div>
