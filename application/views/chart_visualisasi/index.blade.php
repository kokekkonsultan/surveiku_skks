...
<script src="{{ base_url() }}assets/vendor/fusioncharts-suite-xt/js/themes/fusioncharts.theme.accessibility.js"></script>
...
FusionCharts.ready(function() {
    var myChart = new FusionCharts({
        "type": "pie3d",
        "renderAt": "pie_{{$row->id_pertanyaan_unsur}}",
        "width": "100%",
        "height": "350",
        "dataFormat": "json",
        dataSource: {
            "chart": {
                caption: "{{$row->kode_unsur . '. ' . $row->nama_unsur}}",
                // subcaption: "",
                "enableSmartLabels": "1",
                "startingAngle": "0",
                "showPercentValues": "1",
