                            ...
                            <div class="my-5">
                                ...
                                <div class="text-center">
                                    <div class="mt-10 mb-10">
                                        Silahkan menggunakan link dibawah ini untuk mengisikan data kuesioner responden
                                        anda.{{-- Anda bisa menggunakan link survei untuk dibagikan kepada responden di bawah ini. --}}
                                    </div>

                                    <div class='input-group'>
                                        <input type='text' class='form-control' id='kt_clipboard_1'
                                            value="{{ base_url() }}survei/{{ $manage_survey->slug }}/{{ $manage_survey->uuid_surveyor }}"
                                    ...
                                    @php
                                    echo anchor(base_url().'survei/'. $manage_survey->slug. '/' .
                                    $manage_survey->uuid_surveyor, '<i class="fas fa-globe"></i>
