        ...
        <div class="col-md-12">
                ...
                <div class="card-body d-flex align-items-center">
                    <div>
                        <h3 class="text-white font-weight-bolder line-height-lg mb-5">
                            E-SERTIFIKAT PER BAGIAN {{ strtoupper($nama_survey) }}
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-5">
                        Anda bisa menerbitkan sertifikat IKK dengan melengkapi form dibawah ini. Sertifikat yang
                    ...
                    <form method="post"
                        action="<?php echo base_url() . 'e-sertifikat-per-bagian/'. $ci->uri->segment(2) . '/' . $ci->uri->segment(3)  ?>"
                        target="_blank">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary font-weight-bold" target="_blank"><i
                                    class="fas fa-print"></i>Generate Serifikat</button>
                        </div>
