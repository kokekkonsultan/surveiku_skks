                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge badge-info">
                                            {{ ROUND(($row->perolehan_online + $row->perolehan_offline)/($row->target_online + $row->target_offline)* 100, 2) }}
                                            %
                                        </span>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center"><span class="badge badge-success">{{$row->perolehan_offline}}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-danger">
                                            {{$row->target_offline - $row->perolehan_offline}}
                                        </span>
                                    </td>
                                </tr>
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge badge-dark">
                                            {{$total_target_offline}}
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-dark">
                                            {{$total_perolehan_offline}}
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge badge-dark">
                                            {{$total_target_offline - $total_perolehan_offline}}
                                        </span>
                                    </td>
                                </tr>
