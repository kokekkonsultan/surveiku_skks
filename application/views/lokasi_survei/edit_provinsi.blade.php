...
<div class="container">
    ...
    <div class="row justify-content-md-center">
        ...
        <form method="post" action="<?= base_url('lokasi-survei/edit-provinsi/'.$data_provinsi->id) ?>">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nama_provinsi" name="nama_provinsi" value="<?= $data_provinsi->nama_provinsi; ?>" required>
                        </div>
                    </div>
