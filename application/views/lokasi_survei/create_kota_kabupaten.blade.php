...
<div class="container">
    ...
    <div class="row justify-content-md-center">
        ...
        <form method="post" action="<?= base_url('lokasi-survei/insert-kota-kabupaten') ?>">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nama_kota_kabupaten" name="nama_kota_kabupaten"  required>
                            <input type="hidden" id="provinsi_id" name="provinsi_id" value="<?= $provinsi_id; ?>">
                        </div>
                    </div>
