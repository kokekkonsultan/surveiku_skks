...
<body>
        ...
        <table style="width: 100%; text-align:center; margin-top:55px; margin-left:5px;">
            <tr style="font-weight: bold;">
                <td>
                    ...
                    <?php else : ?>
                        <img src="<?php echo base_url(); ?>assets/klien/foto_profile/<?php echo $user->foto_profile ?>" height="80" alt="" />
                    <?php endif; ?>
                </td>
            </tr>
        </table>
  ...
  margin-right: auto;">
            ...
            <tr style="font-size: 13px;">
                <th style="width:20%;">NILAI KONVERSI</th>
                <th style="width:2%;"></th>
                <th style="width:33%;">NAMA LAYANAN</th>
            </tr>

            <tr style="padding-top: 20px; padding-bottom: 20px;">
                <th style="border: 1px black solid; width:20%; text-align:center;  padding-right: 20px; padding-left: 20px; text-align:center;">

                    <div style="font-size: 60px;"><?php echo ROUND($nilai->nilai_konversi, 2) ?></div>
                    <div style="font-size: 15px;">Kategori :
