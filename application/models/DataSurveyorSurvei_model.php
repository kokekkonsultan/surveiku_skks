...
class DataSurveyorSurvei_model extends CI_Model
{

    var $table          = '';
    var $column_order   = array(null, null, null, null, null);
    var $column_search  = array('surveyor.kode_surveyor', 'users.first_name');
    ...
    public function dropdown_wilayah_survei($table_identity)
    {
