...
class ProfileController extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->data['kelompok_skala'] = $this->db->get_where('kelompok_skala', ['id' => $this->data['data_user']->id_kelompok_skala]);

		// if($kelompok_skala->num_rows() == 0){
		// 	$this->data['kelompok_skala'] = '';
		// } else {
		// 	$this->data['kelompok_skala'] = $kelompok_skala->row()->nama_kelompok_skala;
		// }
