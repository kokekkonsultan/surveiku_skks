...
class ContactController extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['conEmail'] = [
			...
			'id'		=> 'conEmail',
			'type'		=> 'email',
			'value'		=>	$this->form_validation->set_value('conEmail'),
			'class'		=> 'form-control',
			'required'	=> 'required',
			'placeholder' => 'Email'
		];
	...
	public function validate_message()
	{
		...
		$this->form_validation->set_rules('conTelp', 'Telepon', 'trim');
...
<p>Berikut diinformasikan, ada pengunjung web https://survei-ikk.com yang megirim pesan melalui halaman kontak dengan detail sebagai berikut:</p>
<p>&nbsp;</p>";
...
<strong>Admin</strong> </p>
				...
				echo json_encode(array("status" => FALSE, "error" => '<div class="alert alert-warning alert-dismissible fade show" role="alert">
								  ...
								  </div>', "message" => 'Captcha yang anda masukkan salah'));
	        }
