...
class RekapAlasanController extends CI_Controller
{
    ...
    public function detail()
    {
        ...
        $this->data['pertanyaan'] = $this->db->get_where("pertanyaan_unsur_$get_identity->table_identity", array('id' => $this->uri->segment(5)))->row();
    ...
    public function cetak_pdf()
    {
        ...
        $this->data['pertanyaan'] = $this->db->get('pertanyaan_unsur_' . $table_identity);
